...
public class GsmArenaWithCss2 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement samsung = driver
				.findElement(By.cssSelector("div[class='brandmenu-v2 light l-box clearfix']>ul>li>a"));
		samsung.click();
		
		List<WebElement> finder = driver
				.findElements(By.cssSelector("div.makers>ul>li"));
		System.out.println("No of phones  :" + finder.size());
